      ...
      <form className='mx-auto' action={formAction}>
        ...
        
        {
          ...
          value={state.message||"https://pico.url/test-url"}
            ...
            color='secondary'
            endContent={
              <Image className='hover:cursor-pointer' height={20} width={20} src={open_in_new} alt='open-link-icon' onClick={handleRedirect} />
            }
          />
            <div className="flex justify-between items-center w-full m-2">
                <Button color='primary' variant='flat' onClick={handleCopy} className='w-1/2 mr-1'>
                  Copy link
                </Button>
                <Button type='reset' color='primary' variant='flat' onClick={() => window.location.reload()} className='w-1/2 ml-1'>
                  Shorten another
                </Button>
            </div>
          </>
...

        {
          !state.message
          &&
          <Button className='w-full mx-2' color='primary' variant='flat' type='submit'>
            Pico-fy!
          </Button>
        }
      </form>
